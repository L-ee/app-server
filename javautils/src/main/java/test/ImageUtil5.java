...
public class ImageUtil5 {
    ...
    public static String getCombinationOfhead(List<String> paths, int innerImageLength, int gapLength, boolean zoom) throws IOException {
        ...
        for (int i = 0; i < paths.size(); i++) {
            if (zoom) {
                bufferedImages.add(ImageUtil5.resize2(paths.get(i), innerImageLength, innerImageLength, true));
            } else {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ImageUtil5.getCombinationOfhead(list, 70, 10, true);

...
* <p>Description:星尘科技</p>
* <p>Copyright: Copyright (c) 2015</p>
* <p>Company:星尘科技有限公司</p>
* @author zhusx zhushuxian12@qq.com
* @date 2015-5-2 下午1:48:52
* @version V1.0
*/

public class GetMacAddressUtil
{
	private static  Logger log = Logger.getLogger(GetMacAddressUtil.class);
	/**
	 * 获取当前操作系统名称. 
	...
	public static void main(String[] argc )
	{
		...
		if (os.startsWith("windows"))
		{
			...
			log.info("本地是windows:" + mac);
		} else if (os.startsWith("linux"))
		{
			String mac = getLinuxMACAddress();
			log.info("本地是Linux系统,MAC地址是:" + mac);
		} else
		{
			String mac = getUnixMACAddress();
			log.info("本地是Unix系统 MAC地址是:" + mac);
		}
	}
